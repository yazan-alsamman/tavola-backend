...
Status: **Phase 3 complete, fully verified — Phase 4 in progress (Restaurant CRUD, Restaurant Settings, and Working Hours complete, live-verified)**
...
| 4     | Restaurant Module        | 🟡 In Progress| 20%      |
| 5     | Branch Module            | ⏳ Pending    | 0%       |
| 6     | Table Module             | ⏳ Pending    | 0%       |
...
* Working schedules
* Capacity settings
* Country/currency configuration (see DOMAIN_MODEL.md Money/Currency Ownership)
