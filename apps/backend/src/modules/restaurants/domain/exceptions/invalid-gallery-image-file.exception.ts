 ...
 * i.e. a spoofed/corrupted/malformed upload (never trust the client-supplied
 * Content-Type header alone). Mirrors InvalidAvatarFileException exactly.
 */
export class InvalidGalleryImageFileException extends DomainException {
